...
//     // SHINY GRADIENT
//     const grad = ctx.createLinearGradient(0, 0, revealWidth, 0);
//     grad.addColorStop(0, "#ffffff");
//     grad.addColorStop(0.5, "#ffffffff");
//     grad.addColorStop(1, "#ffffff");

//     ctx.font = "900 110px Arial"; // HK-modular style substitute
//     ctx.fillStyle = grad;
//     ctx.textAlign = "left";
//     ctx.shadowColor = "rgba(180,220,255,0.6)";
//     ctx.shadowBlur = 30;

//     // CLIP FOR TYPE-ON EFFECT
//     ctx.beginPath();
//     ctx.rect(0, y - 90, revealWidth, 140);
//     ctx.clip();
